...
//        System.out.println(albumId);
        String imagePath = WebPicConfig.imagePath + File.separator + imageName;
        try {
            // 保存文件
    ...
    public void showPhoto(Integer photoId, HttpServletResponse response, Float scale) throws IOException {
        ...
        String filepath = new StringBuilder(WebPicConfig.imagePath)
        ...
        // 已经登录的用户，但是不是图片的拥有者
//        if(this.user != null && this.user.getUserRight() == 0 && !Objects.equals(picture.getPhotoUserId(), this.user.getUserId())){
